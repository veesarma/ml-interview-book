...
# Practice stub for src/mlbook/optim/schedules.py
# Fill in every `raise NotImplementedError`, then run:
#     MLBOOK_IMPL=practice pytest tests/ -k schedules -q
# Regenerate a clean stub with:
#     python scripts/make_practice_stubs.py optim/schedules --force
...
def linear_warmup(step: int, warmup_steps: int, peak_lr: float) -> float:
    ...
    raise NotImplementedError('TODO: implement linear_warmup (see the reference in src/mlbook)')
...
def warmup_cosine(step: int, warmup_steps: int, total_steps: int, peak_lr: float, min_lr: float=0.0) -> float:
    ...
    """
    raise NotImplementedError('TODO: implement warmup_cosine (see the reference in src/mlbook)')
...
def warmup_stable_decay(step: int, warmup_steps: int, stable_steps: int, decay_steps: int, peak_lr: float, min_lr: float=0.0) -> float:
    ...
    """
    raise NotImplementedError('TODO: implement warmup_stable_decay (see the reference in src/mlbook)')
...
def inverse_sqrt(step: int, warmup_steps: int, peak_lr: float) -> float:
    ...
    """
    raise NotImplementedError('TODO: implement inverse_sqrt (see the reference in src/mlbook)')
...
def step_decay(step: int, base_lr: float, drop_every: int, gamma: float=0.1) -> float:
    ...
    raise NotImplementedError('TODO: implement step_decay (see the reference in src/mlbook)')
