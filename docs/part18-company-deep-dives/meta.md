...
| Embedding models at scale | Terabyte embedding tables; training is memory- and communication-bound, not FLOP-bound | DLRM ([arXiv 1906.00091](https://arxiv.org/abs/1906.00091), 2019); "Software-Hardware Co-design for Fast and Scalable Training of Deep Learning Recommendation Models" (ISCA 2022, ZionEX); TorchRec |
